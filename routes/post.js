...
const { createPost, getPosts, getRecommendedPosts, getUserPosts, deletePost, editPost } = require('../controllers/postController')
...
module.exports = (Post, Reaction, Comment) => {
    ...
    Router.get('/getRecommendedPosts', authorize(['view_posts']), (req, res) => getRecommendedPosts(Post, Reaction, Comment, req, res))
